...
////////////////////////////////////////////////////////////
/// \brief UTF-8 string conversion functions
///
////////////////////////////////////////////////////////////
namespace Utf8
{
...
In decode(In begin, In end, std::uint32_t& output, std::uint32_t replacement = 0);
...
Out encode(std::uint32_t input, Out output, std::uint8_t replacement = 0);
...
////////////////////////////////////////////////////////////
template <typename In>
std::size_t count(In begin, In end);
...
////////////////////////////////////////////////////////////
template <typename In, typename Out>
Out fromWide(In begin, In end, Out output);
...
////////////////////////////////////////////////////////////
template <typename In, typename Out>
Out fromLatin1(In begin, In end, Out output);
...
////////////////////////////////////////////////////////////
template <typename In, typename Out>
Out toAnsi(In begin, In end, Out output, char replacement = 0, const std::locale& locale = {});
...
////////////////////////////////////////////////////////////
template <typename In, typename Out>
Out toWide(In begin, In end, Out output, wchar_t replacement = 0);
...
////////////////////////////////////////////////////////////
template <typename In, typename Out>
Out toLatin1(In begin, In end, Out output, char replacement = 0);
...
////////////////////////////////////////////////////////////
template <typename In, typename Out>
Out toUtf8(In begin, In end, Out output);
...
////////////////////////////////////////////////////////////
template <typename In, typename Out>
Out toUtf16(In begin, In end, Out output);
...
////////////////////////////////////////////////////////////
template <typename In, typename Out>
Out toUtf32(In begin, In end, Out output);
} // namespace Utf8

////////////////////////////////////////////////////////////
/// \brief UTF-16 string conversion functions
///
////////////////////////////////////////////////////////////
namespace Utf16
{
...
////////////////////////////////////////////////////////////
template <typename Out>
Out encode(std::uint32_t input, Out output, std::uint16_t replacement = 0);
...
////////////////////////////////////////////////////////////
/// \brief UTF-32 string conversion functions
///
////////////////////////////////////////////////////////////
namespace Utf32
{
...
////////////////////////////////////////////////////////////
template <typename Out>
Out encode(std::uint32_t input, Out output, std::uint32_t replacement = 0);
...
////////////////////////////////////////////////////////////
template <typename In>
std::uint32_t decodeAnsi(In input, const std::locale& locale = {});
...
////////////////////////////////////////////////////////////
template <typename In>
std::uint32_t decodeWide(In input);
...
////////////////////////////////////////////////////////////
template <typename Out>
Out encodeAnsi(std::uint32_t codepoint, Out output, char replacement = 0, const std::locale& locale = {});
...
////////////////////////////////////////////////////////////
template <typename Out>
Out encodeWide(std::uint32_t codepoint, Out output, wchar_t replacement = 0);
}; // namespace Utf32
...
///
/// This is a low-level, generic interface for counting, iterating,
...
///
/// All the functions are template, so that you can use any character
/// or string type for a given encoding.
///
////////////////////////////////////////////////////////////
